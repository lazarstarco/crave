...
const DashboardProductDetails = ({
  ...
  const deleteProduct = async () => {
    ...
    fetch(`http://ec2-3-66-85-50.eu-central-1.compute.amazonaws.com:3001/api/products/${id}`, requestOptions)
      .then((response) => {
  ...
  const uploadFile = async (file: any) => {
    ...
    try {
      const response = await fetch("http://ec2-3-66-85-50.eu-central-1.compute.amazonaws.com:3001/api/main-image", {
        method: "POST",
        body: formData,
      });
  ...
  const fetchProductData = async () => {
    fetch(`http://ec2-3-66-85-50.eu-central-1.compute.amazonaws.com:3001/api/products/${id}`)
      .then((res) => {
        return res.json();
      })
      .then((data) => {
    ...
    const imagesData = await fetch(`http://ec2-3-66-85-50.eu-central-1.compute.amazonaws.com:3001/api/images/${id}`, {
      cache: "no-store",
    });
