...
const DashboardSingleCategory = ({
  ...
  const deleteCategory = async () => {
    ...
    fetch(`http://ec2-3-66-85-50.eu-central-1.compute.amazonaws.com:3001/api/categories/${id}`, requestOptions)
      .then((response) => {
  ...
  useEffect(() => {
    fetch(`http://ec2-3-66-85-50.eu-central-1.compute.amazonaws.com:3001/api/categories/${id}`)
      .then((res) => {
        return res.json();
      })
      .then((data) => {
