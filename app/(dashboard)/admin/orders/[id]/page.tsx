...
const AdminSingleOrder = () => {
  ...
  useEffect(() => {
    const fetchOrderData = async () => {
      const response = await fetch(
        `http://ec2-3-66-85-50.eu-central-1.compute.amazonaws.com:3001/api/orders/${params?.id}`,
      );
    ...
    const fetchOrderProducts = async () => {
      const response = await fetch(
        `http://ec2-3-66-85-50.eu-central-1.compute.amazonaws.com:3001/api/order-product/${params?.id}`,
      );
  ...
  const updateOrder = async () => {
    if (
      ...
      fetch(`http://ec2-3-66-85-50.eu-central-1.compute.amazonaws.com:3001/api/orders/${order?.id}`, {
        method: "PUT",
        headers: {
  ...
  const deleteOrder = async () => {
    ...
    fetch(
      `http://ec2-3-66-85-50.eu-central-1.compute.amazonaws.com:3001/api/order-product/${order?.id}`,
      requestOptions,
    ).then((response) => {
      fetch(
        `http://ec2-3-66-85-50.eu-central-1.compute.amazonaws.com:3001/api/orders/${order?.id}`,
        requestOptions,
      ).then((response) => {
