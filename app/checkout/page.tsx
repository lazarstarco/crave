            ...
            <dl className="hidden space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-gray-900 lg:block">
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                ...
                <dd className="text-base">
                  {total === 0 ? 0 : Math.round(total + total / 5 + 350)} RSD
                </dd>
              </div>
            </dl>
          </div>
          ...
          <div className="mx-auto max-w-lg lg:max-w-none">
            ...
            <div className="mt-10 border-t border-gray-200 pt-6 ml-0">
              <button
                ...
                className="w-full rounded-md border border-transparent bg-slate-950 px-20 py-2 text-lg font-medium text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-gray-50 sm:order-last"
              >
                Pay Now
              </button>
            </div>
