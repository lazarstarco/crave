...
const Filters = () => {
  ...
  const [inputCategory, setInputCategory] = useState<InputCategory>({
    ...
    priceFilter: { text: "price", value: 100000 },
    ...
    <div>
        ...
        <div className="form-control">
          <label className="cursor-pointer flex items-center">
            <input
              ...
              className="checkbox appearance-none border border-blue-300 focus:outline-none"
            />
      ...
      <div className="flex flex-col gap-y-1">
        ...
        <div>
          ...
          />
          <span>{`Max price: ${inputCategory.priceFilter.value} RSD`}</span>
        </div>
      </div>
