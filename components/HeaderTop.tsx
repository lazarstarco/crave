...
import { FaDashcube, FaHeadphones } from "react-icons/fa6";
...
const HeaderTop = () => {
  ...
  return (
    <div className="h-10 text-white bg-slate-950 max-lg:px-5 max-lg:h-16 max-[573px]:px-0">
