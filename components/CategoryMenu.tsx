...
const CategoryMenu = () => {
  return (
    <div className="py-10 bg-slate-950">
      ...
      <div className="max-w-screen-2xl mx-auto py-10 gap-x-5 px-16 max-md:px-10 gap-y-5 grid grid-cols-4 max-lg:grid-cols-4 max-md:grid-cols-2 max-[450px]:grid-cols-1">
